...
export const socials = [
  { icon: 'github', href: 'https://github.com/TheKimi7', label: 'GitHub' },
  { icon: 'linkedin', href: 'https://www.linkedin.com/in/pranav-rajendran/', label: 'LinkedIn' },
  { icon: 'x', href: 'https://x.com/thekimi_7', label: 'X' },
  { icon: 'email', href: 'mailto:inbox@pranavrajendran.com', label: 'Email' },
]
